...
{ //每个大括号之间算一个代码块
    static void Main()
    {
        ...
        System.Console.WriteLine(message); // 语句结束用分号结束
        
        string message1, message2; // 一条语句声明两个变量
        message1 = "This is the first message !!";
        message2 = "This is the second message !!";
        System.Console.WriteLine(message1); // 语句结束用分号结束
        System.Console.WriteLine(message2); // 语句结束用分号结束
        ...
        str1 = "abc";
        System.Console.WriteLine(str1); // 语句结束用分号结束

        str1 = "123";
        System.Console.WriteLine(str1); // 语句结束用分号结束

        // 这是控制台输出
        System.Console.WriteLine(str2); // 语句结束用分号结束
        ...
        System.Console.WriteLine("你的名字是: "); // 语句结束用分号结束
        string name = System.Console.ReadLine();
        System.Console.WriteLine("我的名字是: " + name);
        System.Console.WriteLine("我的名字是: {0}", name);
        // {0} 表示后面 0 位的变量, 优势是可以颠倒位置 {1}{0}. 
        System.Console.WriteLine("我的名字是: {0}{1}", name,str2);
        System.Console.WriteLine("我的名字是: {1}{0}", name,str2);
